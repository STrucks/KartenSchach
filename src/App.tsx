...
function BoardDropTarget() { const { setNodeRef } = useDroppable({ id: 'board' }); return <div ref={setNodeRef} className="board-drop" aria-hidden="true" /> }
